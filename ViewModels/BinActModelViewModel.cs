...
public partial class BinActModelViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> BinActModel { get; } = new ();
    Random random = new ();
    public BinActModelViewModel()
    {
