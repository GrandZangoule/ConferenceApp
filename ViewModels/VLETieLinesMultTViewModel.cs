...
public partial class VLETieLinesMultTViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> VLETieLinesMultT { get; } = new ();
    Random random = new ();
    public VLETieLinesMultTViewModel()
    {
    ...
    Task LoadDataAsync()
    {
        ...
        VLETieLinesMultT.AddRange(sorted);
