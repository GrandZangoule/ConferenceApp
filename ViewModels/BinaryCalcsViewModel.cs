...
public partial class BinaryCalcsViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> BinaryCalcs { get; } = new ();
    Random random = new ();
    public BinaryCalcsViewModel()
    {
