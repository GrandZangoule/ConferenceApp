...
public partial class VLETieLinesSingPViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> VLETieLinesSingP { get; } = new ();
    Random random = new ();
    public VLETieLinesSingPViewModel()
    {
    ...
    Task LoadDataAsync()
    {
        ...
        VLETieLinesSingP.AddRange(sorted);
