...
public partial class VLExiyiViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> VLExiyi { get; } = new ();
    Random random = new ();
    public VLExiyiViewModel()
    {
