...
public partial class VLEFlashViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> VLEFlash { get; } = new ();
    Random random = new ();
    public VLEFlashViewModel()
    {
