...
public partial class BinMcCabeViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> BinMcCabe { get; } = new ();
    Random random = new ();
    public BinMcCabeViewModel()
    {
