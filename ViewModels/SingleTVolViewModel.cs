...
public partial class SingleTVolViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> SingleTVol { get; } = new ();
    Random random = new ();
    public SingleTVolViewModel()
    {
