...
public partial class VLETieLinesSingTViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> VLETieLinesSingT { get; } = new ();
    Random random = new ();
    public VLETieLinesSingTViewModel()
    {
    ...
    Task LoadDataAsync()
    {
        ...
        VLETieLinesSingT.AddRange(sorted);
