...
public partial class VLETieLinesMultPViewModel : ObservableObject
{    
    public int Day { get; set; }
    public ObservableRangeCollection<Grouping<string, Session>> VLETieLinesMultP { get; } = new ();
    Random random = new ();
    public VLETieLinesMultPViewModel()
    {
    ...
    Task LoadDataAsync()
    {
        ...
        VLETieLinesMultP.AddRange(sorted);
